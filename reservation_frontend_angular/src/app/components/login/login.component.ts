...
export class LoginComponent {
  ...
  login(): void {
    const request: AuthRequest = { username: this.username, password: this.password };
  ...
  register(): void {
    const request: RegistrationRequest = {username: this.username, password: this.password };
